...
public class Node {
    ...
    public void onCommand(String command) {
        if (this.matchTransferCommand(command)) return;
        if (this.matchServerCommand(command)) return;
    	if (this.matchPingCommand(command)) return;
    ...
    private void receiveTCP(int srcAddr, Packet packet) {
        ...
        tcpMan.receive(srcAddr, srcPort, destAddr, destPort, transport);
    }
